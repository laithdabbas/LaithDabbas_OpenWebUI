...
from open_webui.services.license_service import load_license, validate_license
...
async def lifespan(app: FastAPI):
    ...
    if not validate_license():
        log.warning("License invalid or missing; user registrations will be blocked.")
